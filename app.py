...
class App:
    ...
    def init_gui(self):
        ...
        self.classname_one = simpledialog.askstring("Classname One", "Enter first class:", parent=self.window)
        self.classname_two = simpledialog.askstring("Classname Two", "Enter second class:", parent=self.window)
